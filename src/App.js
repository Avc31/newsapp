...
const App = () => {
  ...
  const handleSearch = (query) => {
    setSearchQuery(query); // Update the search query state when the search form is submitted
  };
    ...
    <div className='container-fluid'>
      ...
      <div className='row'>
        ...
        <div className='col-md-7'>
            ...
            <Routes>
              <Route path="/" element={<News searchQuery={searchQuery}  setProgress={setProgress} apiKey={apiKey} key="general" pageSize={pageSize} country="us" category="general" />} />
